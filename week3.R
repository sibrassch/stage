# GOAL 1: h6 boek Tom lezen                         X
# GOAL 2: likelihood van een gewoon muntstuk        X
# GOAL 3: likelihood van eigen model uitschrijven   X
# GOAL 4: alpha en beta schatten in eigen model
